...
JSON Sample
-------------------------------------
{    "id": "aSjwdnrTsODPwRXUogIwUNrhQ",    "tenant_id": "ouNlPZyFbYfwKCqZEpWvMAftO",    "mobile": "XXvotXddNcOwhWSVegVEFryBo",    "email": "VtdeckIBUuXpIdHYamnkyPCiR",    "identity": "hDMDuAhgMdXbocNcvJodjsiQm",    "name": "qPIMZwIkjCbmiaoIuGnupPROS",    "zh_name": "tTDRQpZoaPYXMlFFjxMCxFGpY",    "gender": 91,    "address": "SNugumOssbVFiFxJVWweOUIJJ",    "password": "wTyUUhEGEnkEVnhKCuAcdhmWO",    "type": 70,    "org_id": "DhJcSSySvtQXZIxHLSJnnnbjV",    "id_card": "PEKhtIxySbrhGDavgoDsXrqyQ",    "work_number": "ZPeRwxLbgPdJGfiFNJGMPsOTZ",    "avatar_url": "PxeHsvPxopaslPhbnLSsplUDM",    "create_at": 58,    "update_at": 83,    "remark": "UWGbHThJAAwLmIOFQxcwHsQgq",    "status": 36,    "roles": 92}


Comments
-------------------------------------
[ 0] Warning table: v_user_with_role does not have a primary key defined, setting col position 1 id as primary key
Warning table: v_user_with_role primary key column id is nullable column, setting it as NOT NULL
...
var (
	User_with_role_FIELD_NAME_id = "id"

	User_with_role_FIELD_NAME_tenant_id = "tenant_id"

	User_with_role_FIELD_NAME_mobile = "mobile"

	User_with_role_FIELD_NAME_email = "email"
	...
	User_with_role_FIELD_NAME_address = "address"

	User_with_role_FIELD_NAME_password = "password"

	User_with_role_FIELD_NAME_type = "type"

	User_with_role_FIELD_NAME_org_id = "org_id"

	User_with_role_FIELD_NAME_id_card = "id_card"

	User_with_role_FIELD_NAME_work_number = "work_number"

	User_with_role_FIELD_NAME_avatar_url = "avatar_url"

	User_with_role_FIELD_NAME_create_at = "create_at"

	User_with_role_FIELD_NAME_update_at = "update_at"

	User_with_role_FIELD_NAME_remark = "remark"

	User_with_role_FIELD_NAME_status = "status"

	User_with_role_FIELD_NAME_roles = "roles"
)

// User_with_role struct is a row record of the v_user_with_role table in the  database
type User_with_role struct {
	...
	Roles any `json:"roles"` //roles

}

var User_with_roleTableInfo = &TableInfo{
	Name: "v_user_with_role",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "id",
			Comment: `id`,
			Notes: `Warning table: v_user_with_role does not have a primary key defined, setting col position 1 id as primary key
Warning table: v_user_with_role primary key column id is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
...
func (u *User_with_role) TableName() string {
	return "v_user_with_role"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (u *User_with_role) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (u *User_with_role) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (u *User_with_role) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (u *User_with_role) TableInfo() *TableInfo {
	return User_with_roleTableInfo
}
